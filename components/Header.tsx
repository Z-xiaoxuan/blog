...
const Header = () => {
  return (
    <header className="fixed top-0 left-1/2 flex w-full -translate-x-1/2 justify-center bg-gradient-to-r from-transparent via-black/20 to-transparent px-5 py-2">
